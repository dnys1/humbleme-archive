...
// Credit to: https://gist.github.com/Katarn/da6c45795247c4e882e337317a1050bd
...
class HtmlTextView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    RichText contents = RichText(text: span);

    return Container(padding: const EdgeInsets.all(16.0), child: contents);
  }
  ...
  TextSpan _textSpan(Map node) {
    TextSpan span = TextSpan(text: node['text'], style: node['style']);
